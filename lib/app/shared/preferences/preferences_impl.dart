import 'package:restaurant_tour/app/shared/custom_exceptions/custom_exceptions.dart';
...
final class PreferencesImpl implements IPreferences {
  ...
  @override
Future<void> save<T>({required T data, required PrefencesKeyEnum key, required PreferencesType type}) async {
    try {
      switch (type) {
        case PreferencesType.string:
